...
<body >
    ...
    <div class="jumbotron">
        ...
        <div class="col-md-4">
            <label class="form-label" font-style>Kode</label>
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="jenisKamar" readonly value="DELUXE">
        </div>

        <div class="col-md-4">
            <label class="form-label" font-style>Harga Kamar</label>
            <input type="text" class="form-control" name="harga" readonly value="150.000">
        </div>
